...
var require_discord_bot = __commonJS({
  "../common-node/lib/bot/discord-bot.js"(exports) {
    ...
    var getProjectSummary = function(_a) {
      ...
      return "".concat(projectKey, ":\n").concat(baseWebUrl, "/").concat(projectKey, "/\n").concat(projectMetadata.description, "\n");
    };
    var getNftSummary = function(_a) {
      var baseWebUrl = _a.baseWebUrl, projectKey = _a.projectKey, tokenId = _a.tokenId, nft = _a.nft;
      return "".concat(projectKey, ": #").concat(nft.nft.id, "\n").concat(baseWebUrl, "/").concat(projectKey, "/").concat(tokenId, "/\n\n- Rank: ").concat(nft.rank, "\n- Score: ").concat(nft.rarityScore.toFixed(2), "\n\n### Attributes\n\n```\nCommonality\n").concat(nft.attributeRarities.map(function(x) {
        return "- [".concat(__spreadArray([], __read(new Array(Math.floor(x.ratio * 10))), false).map(function(x2) {
          return "%";
        }).join("").padStart(10, "."), "]").concat((100 * x.ratio).toFixed(1).padStart(5, " "), "% - ").concat(x.trait_type, ":").concat(x.value);
      }).join("\n"), "\n```\n\n### Description\n\n").concat(nft.nft.description, "\n");
    };
        ...
        return __generator(this, function(_d) {
          switch (_d.label) {
            case 0:
              ...
              if (!(kind === "projects"))
                return [3, 3];
              return [4, (0, node_fetch_1.default)("".concat(baseDataUrl, "/projects.json"))];
            case 1:
              result = _d.sent();
            ...
            case 4:
              _d.trys.push([4, 7, , 8]);
              return [4, (0, node_fetch_1.default)("".concat(baseDataUrl, "/").concat(projectKey, "/project.json"))];
            case 5:
              result = _d.sent();
              return [4, result.json()];
            case 6:
              ...
              return [2, {
                kind,
                message: "".concat(getProjectSummary({ baseWebUrl, projectKey, projectMetadata: project.project }))
              }];
            case 7:
              _b = _d.sent();
              return [2, {
                kind,
                error: "Could not find project: ".concat(projectKey),
                _raw: command
              }];
            case 8:
              if (!(kind === "nft"))
            ...
            case 9:
              ...
              return [4, (0, node_fetch_1.default)("".concat(baseDataUrl, "/").concat(projectKey, "/").concat(tokenId, ".json"))];
            case 10:
              result = _d.sent();
              return [4, result.json()];
            case 11:
              ...
              return [2, {
                kind,
                message: "".concat(getNftSummary({ baseWebUrl, projectKey, tokenId, nft }))
              }];
            case 12:
              _c = _d.sent();
              return [2, {
                kind,
                error: "Could not find nft: ".concat(projectKey, "/").concat(tokenId),
                _raw: command
              }];
            case 13:
              return [2, {
                kind: "help",
                message: "".concat(discord_types_1.discordCommands.map(function(x) {
                  return "".concat(x.command, ": ").concat(x.description, "\n");
                }).join(""), "\n        \n        ")
              }];
          }
        });
    ...
    var registerDiscordSlashCommands = function(_a) {
      ...
      return __awaiter(void 0, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              globalDiscordUrl = "https://discord.com/api/v8/applications/".concat(config2.applicationId, "/commands");
              guildDiscordUrl = "https://discord.com/api/v8/applications/".concat(config2.applicationId, "/guilds/").concat(guild === null || guild === void 0 ? void 0 : guild.guildId, "/commands");
              ...
              headers.set("Authorization", "Bot ".concat(config2.botToken));
            ...
            case 2:
              ...
              return [2, {
                message: guild ? "Registered in ".concat(guild.guildId, " with ").concat(guild.defaultProjectKey) : "Registered Globally"
              }];
          }
        });
      });
